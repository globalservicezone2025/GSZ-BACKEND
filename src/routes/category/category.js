...
import {
  ...
  countActiveCategories, // Import the new function
...
router.get("/v1/categories", categoryList, getCategories);
router.get(
  "/v1/user/categories",
  categoryUserList,
  verify,
...
router.get("/v1/categories/:id", categorySingle, getCategory);
router.put(
  "/v1/categories/:id",
  categoryEdit,
  verify,
...
// New route for counting active categories
router.get("/v1/categories/count/active", countActiveCategories);
